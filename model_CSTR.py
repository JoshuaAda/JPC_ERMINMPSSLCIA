...
def template_model(symvar_type='SX'):
    ...
    Q_dot = model.set_variable(var_type='_u', var_name='Q_dot',input_type_integer=False)

    # Fixed parameters:
    T_in=model.set_variable(var_type='_p', var_name='T_in')
    m_k=model.set_variable(var_type='_p', var_name='m_k')
    C_A0 = model.set_variable(var_type='_p', var_name='C_A0')#(5.7 + 4.5) / 2.0 * 1.0
    alpha = model.set_variable(var_type='_p', var_name='alpha')
    beta = model.set_variable(var_type='_p', var_name='beta')
    H_R_ab = model.set_variable(var_type='_p', var_name='H_R_ab')
    H_R_bc = model.set_variable(var_type='_p', var_name='H_R_bc')
